...
//		activity.overridePendingTransition(R.anim.fade_in,R.anim.fade_out);
		...
		lp = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
				activity.getResources().getDimensionPixelOffset(R.dimen.dimen_50));
		...
		LinearLayout.LayoutParams lp22 = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
				activity.getResources().getDimensionPixelOffset(R.dimen.dimen_45));
		lp22.setMargins(20, 20, 20, 20);
		Button button2 = new Button(activity);
		button2.setText("取消");
		button2.setTextSize(16);
		button2.setTextColor(activity.getResources().getColor(R.color.color_3c3c3c));
		...
		line.setBackgroundColor(activity.getResources().getColor(R.color.default_circle_indicator_stroke_color));
		llPanel.addView(line);
	...
	private void initAnims() {
		animShow = new TranslateAnimation(
				...
				Animation.RELATIVE_TO_SELF, 0,
				Animation.RELATIVE_TO_SELF, 1,//1
				Animation.RELATIVE_TO_SELF, 0);
