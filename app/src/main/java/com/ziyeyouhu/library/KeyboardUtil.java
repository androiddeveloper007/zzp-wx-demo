...
public class KeyboardUtil {
    ...
    OnClickFinishTextListener onClickFinishText;
...
//        keyBoardLayout.setAnimation(AnimationUtils.loadAnimation(mActivity, R.anim.bottom_in));
        
        keyBoardLayout.setVisibility(View.GONE);
        keyBoardLayout.setBackgroundColor(mActivity.getResources().getColor(R.color.product_list_bac));
        initLayoutHeight((LinearLayout) keyBoardLayout);//LinearLayout
...
//            Log.d("KeyboardUtil", "visible");
    ...
    public void initLayoutHeight(LinearLayout layoutView) {//FrameLayout
    ...
    private void setMargins(View view, int left, int top, int right, int bottom) {//LinearLayout
...
//				WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);
    ...
    private void keyBoardScroll(final EditText editText, int scorllTo) {
        ...
        vto_bighexagon.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                // // 防止多次促发
                root_view.getViewTreeObserver().removeGlobalOnLayoutListener(this);
            }
        });
    }
    ...
    class finishListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if(onClickFinishText!=null)
                onClickFinishText.onClickFinishText();
            hideKeyboardLayout();
        }
    }

    public void setOnClickFinishText(OnClickFinishTextListener listener){
        onClickFinishText = listener;
    }
...
//				return;
        ...
        public void onRelease(int primaryCode) {
            if (inputType != KeyboardUtil.INPUTTYPE_NUM_ABC
                ...
                keyboardView.setPreviewEnabled(true);//true
            }
        }
...
//        keyboardView.setAnimation(AnimationUtils.loadAnimation(mActivity, R.anim.bottom_in));
//        mKeyboardWindow = new PopupWindow(keyboardView,
//        ViewGroup.LayoutParams.MATCH_PARENT,
//        ViewGroup.LayoutParams.WRAP_CONTENT);
//    	mKeyboardWindow.setAnimationStyle(R.style.popuStyle);
...
//	        }
//	    });
//		mKeyboardWindow.showAtLocation(mActivity.getWindow().getDecorView(), Gravity.BOTTOM, 0, 0);//mView
    }
...
//            Log.d("KeyboardUtil", "visible");
    ...
    public interface OnClickFinishTextListener {
        void onClickFinishText();
    }
    /**
     * 监听键盘变化
     */
