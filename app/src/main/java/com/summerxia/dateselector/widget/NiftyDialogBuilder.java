...
public class NiftyDialogBuilder extends Dialog implements DialogInterface {
	...
	private void init(Context context) {
		...
		mRelativeLayoutView = (RelativeLayout) mDialogView.findViewById(R.id.main_dialog);
	...
	public NiftyDialogBuilder withTitle(CharSequence title) {
		...
		mTitle.setTextSize(TypedValue.COMPLEX_UNIT_PX,context.getResources().getDimensionPixelSize(R.dimen.dimen_14));
		return this;
	}
	...
	public NiftyDialogBuilder withPreviousText(String text) {
		...
		mPreviousText.setTextSize(TypedValue.COMPLEX_UNIT_PX,context.getResources().getDimensionPixelSize(R.dimen.dimen_14));
	...
	public NiftyDialogBuilder withNextText(String text) {
		...
		mNextText.setTextSize(TypedValue.COMPLEX_UNIT_PX,context.getResources().getDimensionPixelSize(R.dimen.dimen_14));
