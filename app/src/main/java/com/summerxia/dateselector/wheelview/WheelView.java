...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xFF000000;//选定时的文字颜色

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xff999999;//未选定时的文字颜色0xff5555550xFFE1E1E1
...
//		TypedArray a = context.obtainStyledAttributes(attrs,R.styleable.cityselector); 
//		
//		boolean isLeft = a.getBoolean(R.styleable.cityselector_isLeft, true);
//
//		left = isLeft;
//		
//		a.recycle();
...
//		a.recycle();
	 ...
	 */
	public static boolean left = true;//表示左边的文字，取消按钮
