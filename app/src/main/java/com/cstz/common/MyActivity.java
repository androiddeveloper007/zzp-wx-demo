...
public class MyActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SysApplication.getInstance().addActivity(this);// 添加到SysApplication中，方便一次关闭 SysApplication.getInstance(this)
    }
    ...
    public void postData(Map<String, Object> map, final String action, RelativeLayout view, final PostType postType) {
        if (Device.getConnectedType(MyActivity.this) == -1) {
            if (view != null) {
                mAlertView = view;
                alertView(AlertViewType.NO_CONNECTION);
            } else {
                ToastMakeText.showToast(MyActivity.this, "当前网络已断开", 1000);
...
//		params.addParameter("sys", "Android");
            ...
            public void onSuccess(String arg0) {
                ...
                try {
                    ...
                    if (result.equals("1")) {
                        ...
                        // 重新登录
                        new SharedPreferencesData(MyActivity.this).removeAll();
                        requestFail(object.getString("msg"), postType);
                        Intent intent = new Intent(MyActivity.this, Login.class);
                        MyActivity.this.startActivity(intent);
                        MyActivity.this.finish();//会话过期时，关闭当前页面
                    } else {
                        requestFail(object.getString("msg"), postType);
                    }
    ...
    public void requestConnectionFail(PostType postType) {
        ToastMakeText.showToast(MyActivity.this, "服务器连接失败", 2000);
    }
    ...
    public void showToast(String str){
        ToastMakeText.showToast(this,str,1200);
    }
    public void showToast(String str,int duration){
        ToastMakeText.showToast(this,str,duration);
    }
