 ...
 *
 */
public class LuckyDrawDialog extends BaseTitleDialog_v1 implements View.OnClickListener {
	...
	public LuckyDrawDialog(Context ctx, double p) {
		this(ctx, true, p);
	}
	
	public LuckyDrawDialog(Context ctx, boolean cancelable, double p) {
		super(ctx,p);
		c=ctx;
		setContentView(View.inflate(getContext(), R.layout.luckydraw_dialog, null), 
...
//		handler.post(myRunnable);
	...
	private static runnablefinished runnablefinished;
