 ...
 *
 */
public class LuckyDrawDialog_1 extends BaseTitleDialog_v1 implements View.OnClickListener {
	...
	public LuckyDrawDialog_1(Context ctx, double p) {
		this(ctx, true, p);
	}
	
	public LuckyDrawDialog_1(Context ctx, boolean cancelable, double p) {
		super(ctx,p);
		c=ctx;
		setContentView(View.inflate(getContext(), R.layout.luckydraw_dialog_1, null), 
...
//		handler.post(myRunnable);
	...
	public void setMessage(String msg,int textsize) {
		tvMsg.setTextSize(TypedValue.COMPLEX_UNIT_PX, c.getResources().getDimensionPixelSize(textsize));
		tvMsg.setText(msg);
	}
