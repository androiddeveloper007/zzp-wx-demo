        ...
        if (getFirstVisiblePosition() == 0) {
            ...
            if (mEnablePullRefresh && mPullRefreshing != true) {
                ...
                if (mHeaderViewHeight == 0) {
                    int width = 100;
                    mHeaderViewContent.measure(MeasureSpec.makeMeasureSpec(
                            width, MeasureSpec.AT_MOST),
                            MeasureSpec.makeMeasureSpec((1 << 30) - 1,
                                    MeasureSpec.AT_MOST));
                    mScroller.startScroll(0, 0, 0,
                            mHeaderViewContent.getMeasuredHeight(),
                            SCROLL_DURATION);
                    invalidate();
                } else {
