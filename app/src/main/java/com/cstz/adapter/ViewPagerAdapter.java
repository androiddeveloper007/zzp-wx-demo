...
public class ViewPagerAdapter extends PagerAdapter {
	...
	private void setGuided() {
		...
		//将versionCode保存至sp中，用于下一次应用升级时判断sp中值小于getversionCode(),显示guide页
		...
		SharedPreferencesData sp = new SharedPreferencesData(activity);
		sp.setOtherIntValue("versionCode", versionCode);
	}
