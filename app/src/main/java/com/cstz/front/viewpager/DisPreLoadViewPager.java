 ...
 */  
public class DisPreLoadViewPager extends ViewGroup {  
    ...
    public DisPreLoadViewPager(Context context) {  
        super(context);  
        initViewPager();  
    }  
  
    public DisPreLoadViewPager(Context context, AttributeSet attrs) {  
        super(context, attrs);  
        initViewPager();  
    }  
