 ...
 * 首页
 */
public class Index0 extends MyFragment implements OnClickListener, OnItemClickListener {
    private BGABanner _bannerView;

    private ArrayList<Map<String, Object>> _bannerList = new ArrayList<Map<String, Object>>();
    private List<String> banner_list = new ArrayList<String>();
    ...
    public void initview(View view) {
        ...
        _listview = (XListView) view.findViewById(R.id.listView_index);
                ...
                if (object.has("data")) {
                    try {
                        ...
                        for (int i = 0; i < length; i++) {
                            ...
                            banner_list.add(img_url);//  img.getString("imgUrl")
                        }
                        _bannerView = (BGABanner) view.findViewById(R.id.index_banner);// AutoScrollViewPager
//                        _bannerView.setAdapter(new MyAdapter(banner_list));//_bannerViewList
    ...
    class MyAdapter_p extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = LayoutInflater.from(Index0.this.getActivity()).inflate(R.layout.index_list, parent, false);//null
                ...
                houdler.progressBar_index = (ProgressBar) convertView.findViewById(R.id.progressBar_index);
            ...
            houdler.publisher.setText("来源：" + listget.get(position).get("publisher").toString());
...
//                    break;
            ...
            if (xins == 1) {
                houdler.imageview_xins.setBackgroundResource(R.drawable.xins);
                houdler.iv_index_list_next.setVisibility(View.GONE);
            } else {
                houdler.imageview_xins.setBackgroundResource(0);
        ...
        class myhouder {
            ...
            private ProgressBar progressBar_index;//进度
