 ...
 * 资金明细
 */
public class FundDetail extends MyActivity implements OnClickListener {
...
//    MySliderCg slider_zjmx;
    ...
    private library.widget.xlistview.XListView lv0, lv1, lv2, lv3, lv4,lv5;
    private List<Map<String, String>> listget0, listgetTotal0,listget1, listgetTotal1,listget2,
            listgetTotal2,listget3, listgetTotal3,listget4, listgetTotal4,listget5, listgetTotal5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(TextUtils.equals("-1",oldAccountCloseDay) && !TextUtils.equals("1", getIntent().getStringExtra("regAsDeposit")))
            ivNavigationRight.setVisibility(View.VISIBLE);
        else
    ...
    private void initViewStub(boolean noData) {
        if (noData) {
            stub0 = (ViewStub) findViewById(R.id.stub_fund_detail0);
            stub0.inflate();
            ...
            stub1 = (ViewStub) findViewById(R.id.stub_fund_detail1);
            stub1.inflate();
//            slider_zjmx = (MySliderCg) findViewById(R.id.slider_zjmx);
...
//        });
        ...
        page6.setScrollableView((XListView) page6.findViewById(R.id.lv_funddetail_tab0));
        viewlist.add(page1);
        initPage0();
        viewlist.add(page2);
        initPage1();
