 ...
 * 借款人资金明细
 */
public class BorrowerFundDetail extends MyActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.aa_activity_borrower_fund_detail);
    ...
    private void initViewStub(boolean b) {
        if (b) {
            ...
            LinearLayout ll_title_fund_detail = (LinearLayout) findViewById(R.id.ll_title_fund_detail);
            //判断如果是对公账户，隐藏头部三条数据
            if(TextUtils.equals("2", App.borrowerType))
                ll_title_fund_detail.setVisibility(View.GONE);
            initView();
        }
    }
    ...
    private void initView() {
        ...
        initPage3();
        initPage4();
        pager_repayment.setAdapter(new MyPagerAdapterCg(viewlist));
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        if (scrollableLayout != null) {
            ...
            scrollableLayout.setCurrentScrollableContainer(viewlist.get(pager_repayment.getCurrentItem()));
        }
    }
