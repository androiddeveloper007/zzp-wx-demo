 ...
 * @author zzp
 */
public class CunGuanMailDialog extends BaseDialog {
    private LinearLayout frContent;

    public CunGuanMailDialog(Context context, double p) {
        super(context);
        super.setContentView(R.layout.dialog_cungaun_mail);
