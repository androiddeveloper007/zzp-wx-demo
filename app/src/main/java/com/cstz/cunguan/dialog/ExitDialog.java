...
public class ExitDialog extends BaseDialog {
    ...
    @BindView(R.id.exit_cg_fill_view)
    public View exit_cg_fill_view;
    @BindView(R.id.layout_button_center)
    public LinearLayout layout_button_center;
    private LinearLayout frContent;

    public ExitDialog(Context context, double p) {
        super(context);
        super.setContentView(R.layout.dialog_cungaun_exit);
    ...
    public void setFillViewVisibility(boolean visible){
        exit_cg_fill_view.setVisibility(visible?View.VISIBLE:View.GONE);
    }
}