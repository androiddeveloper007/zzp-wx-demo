...
public class SlideSwitch extends View {
    ...
    public SlideSwitch(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        shape = a.getInt(R.styleable.slideswitch_shape, SHAPE_CIRCLE);//SHAPE_RECT
        a.recycle();
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                if(slideable){
                    if (ToastMakeText.isFastClick1()) {break;}
    ...
    public void setOnTouchListen(touchListener listener){
        this.touchListen = listener;
    }
}
