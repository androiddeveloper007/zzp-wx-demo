...
public class SegmentControlView_investRecord extends LinearLayout {
	...
	public SegmentControlView_investRecord(Context context) {
		super(context);
		initView();
	}
	
	public SegmentControlView_investRecord(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView();
	}
	
	public SegmentControlView_investRecord(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	private void initView() {
		...
		setSegmentText(0, getContext().getString(R.string.wsy));
		//setSegmentText(1, getContext().getString(R.string.wtz));
		setSegmentText(2, getContext().getString(R.string.ysy));
