 ...
 * @date 2013-10-08
 */
public class XListViewFooterView extends LinearLayout {
...
//    private ImageView mHintImage;
    ...
    public XListViewFooterView(Context context) {
        super(context);
        initView(context);
    }

    public XListViewFooterView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    private void initView(Context context) {
        mLayout = LayoutInflater.from(context).inflate(R.layout.xlistview_footer_0, null);
...
//                    mHintImage.startAnimation(mRotateUpAnim);
            ...
            case STATE_NO_MORE_DATA:
                mHintView.setText(R.string.xlistview_footer_hint_nomoredata);
                break;
        }
