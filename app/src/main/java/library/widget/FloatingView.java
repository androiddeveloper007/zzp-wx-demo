...
import library.listener.ScrollDirectionListener;
import library.listener.scrollview.ObservableScrollView;
import library.listener.scrollview.ScrollViewScrollDetectorImpl;
...
public class FloatingView extends ImageView implements ViewTreeObserver.OnGlobalLayoutListener, ScrollDirectionListener.ScrollViewListener {
    ...
    private final static int DELETE_DEFAULT_WIDTH = 0;//删除图标的默认宽高 20
