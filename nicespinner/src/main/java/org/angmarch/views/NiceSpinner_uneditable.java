...
public class NiceSpinner_uneditable extends TextView {
    ...
    public boolean boolean_edit=false;
    public NiceSpinner_uneditable(Context context) {
        super(context);
        init(context, null);
    }

    public NiceSpinner_uneditable(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public NiceSpinner_uneditable(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (Build.VERSION.SDK_INT > 15 ) {
            setPaddingRelative(defaultPadding, 0, 0,  0);
        } else {
...
//            if (event.getX() >= (this.getWidth() - this.getCompoundDrawables()[2].getBounds().width()) && boolean_edit) {
//            }
